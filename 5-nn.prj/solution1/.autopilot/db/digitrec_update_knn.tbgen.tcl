...
set C_modelArgList {
	...
	{ min_distances_4_V int 6 regular {pointer 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "test_inst_V", "interface" : "wire", "bitwidth" : 49, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "min_distances_4_V", "interface" : "wire", "bitwidth" : 6, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ min_distances_4_V_i sc_in sc_lv 6 signal 6 } 
	{ min_distances_4_V_o sc_out sc_lv 6 signal 6 } 
	{ min_distances_4_V_o_ap_vld sc_out sc_logic 1 outvld 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "min_distances_4_V_i", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "min_distances_4_V", "role": "i" }} , 
 	{ "name": "min_distances_4_V_o", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "min_distances_4_V", "role": "o" }} , 
 	{ "name": "min_distances_4_V_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "min_distances_4_V", "role": "o_ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"], "CDFG" : "digitrec_update_knn", "VariableLatency" : "0", "AlignedPipeline" : "1", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		...
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.distance_V_digitrec_bitcount_fu_125", "Parent" : "0", "Child" : [], "CDFG" : "digitrec_bitcount", "VariableLatency" : "0", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "1", "ControlExist" : "0",
		"Port" : [
		{"Name" : "n_V", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.digitrec_mux_5to1_sel3_6_1_U2", "Parent" : "0", "Child" : []}]}
...
set Spec2ImplPortList { 
	...
	min_distances_4_V { ap_ovld {  { min_distances_4_V_i in_data 0 6 }  { min_distances_4_V_o out_data 1 6 }  { min_distances_4_V_o_ap_vld out_vld 1 1 } } }
}
