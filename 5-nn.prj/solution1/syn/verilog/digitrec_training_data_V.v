...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module digitrec_training_data_V_rom (
...
initial begin
    $readmemh("./digitrec_training_data_V_rom.dat", ram0);
    $readmemh("./digitrec_training_data_V_rom.dat", ram1);
    $readmemh("./digitrec_training_data_V_rom.dat", ram2);
    $readmemh("./digitrec_training_data_V_rom.dat", ram3);
    $readmemh("./digitrec_training_data_V_rom.dat", ram4);
end
...
`timescale 1 ns / 1 ps
module digitrec_training_data_V(
    reset,
    clk,
    address0,
    ce0,
...
digitrec_training_data_V_rom digitrec_training_data_V_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
