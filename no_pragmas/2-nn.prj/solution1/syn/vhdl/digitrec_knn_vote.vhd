...
architecture behav of digitrec_knn_vote is 
    ...
    signal i_V_reg_202 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_sig_cseq_ST_st2_fsm_1 : STD_LOGIC;
    signal ap_sig_40 : BOOLEAN;
    signal tmp_10_cast_fu_133_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_10_cast_reg_207 : STD_LOGIC_VECTOR (5 downto 0);
    signal exitcond1_fu_113_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_V_fu_143_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal j_V_reg_215 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_sig_cseq_ST_st3_fsm_2 : STD_LOGIC;
    signal ap_sig_55 : BOOLEAN;
    signal exitcond_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal agg_result_V_0_agg_result_V_s_fu_173_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal min_2_min_fu_181_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal sum_fu_193_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal p_1_reg_90 : STD_LOGIC_VECTOR (1 downto 0);
    signal min_1_reg_101 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_11_cast_fu_158_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_fu_125_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_7_cast_fu_149_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_s_fu_153_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal min_1_cast_fu_163_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_167_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_8_cast_fu_189_p1 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((ap_const_lv1_0 = exitcond_fu_137_p2)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond1_fu_113_p2 = ap_const_lv1_0))) then
                    tmp_10_cast_reg_207(4 downto 1) <= tmp_10_cast_fu_133_p1(4 downto 1);
            end if;
        end if;
    end process;
    tmp_10_cast_reg_207(0) <= '0';
    tmp_10_cast_reg_207(5) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, exitcond1_fu_113_p2, exitcond_fu_137_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st3_fsm_2 => 
                if (not((ap_const_lv1_0 = exitcond_fu_137_p2))) then
                    ap_NS_fsm <= ap_ST_st2_fsm_1;
                else
    ...
    agg_result_V_0_agg_result_V_s_fu_173_p3 <= 
        i_val_V_reg_66 when (tmp_6_fu_167_p2(0) = '1') else 
    ...
    exitcond_fu_137_p2 <= "1" when (p_1_reg_90 = ap_const_lv2_2) else "0";
    i_V_fu_119_p2 <= std_logic_vector(unsigned(i_val_V_reg_66) + unsigned(ap_const_lv4_1));
    j_V_fu_143_p2 <= std_logic_vector(unsigned(p_1_reg_90) + unsigned(ap_const_lv2_1));
    knn_set_V_address0 <= tmp_11_cast_fu_158_p1(5 - 1 downto 0);
    ...
    min_1_cast_fu_163_p1 <= std_logic_vector(resize(unsigned(min_1_reg_101),32));
    min_2_min_fu_181_p3 <= 
        min_1_cast_fu_163_p1 when (tmp_6_fu_167_p2(0) = '1') else 
        min_reg_78;
    sum_fu_193_p2 <= std_logic_vector(unsigned(min_1_reg_101) + unsigned(tmp_8_cast_fu_189_p1));
    tmp_10_cast_fu_133_p1 <= std_logic_vector(resize(unsigned(tmp_fu_125_p3),6));
    tmp_11_cast_fu_158_p1 <= std_logic_vector(resize(unsigned(tmp_s_fu_153_p2),64));
    tmp_6_fu_167_p2 <= "1" when (signed(min_1_cast_fu_163_p1) < signed(min_reg_78)) else "0";
    tmp_7_cast_fu_149_p1 <= std_logic_vector(resize(unsigned(p_1_reg_90),6));
    tmp_8_cast_fu_189_p1 <= std_logic_vector(resize(unsigned(knn_set_V_q0),7));
    tmp_fu_125_p3 <= (i_val_V_reg_66 & ap_const_lv1_0);
    tmp_s_fu_153_p2 <= std_logic_vector(unsigned(tmp_10_cast_reg_207) + unsigned(tmp_7_cast_fu_149_p1));
end behav;
