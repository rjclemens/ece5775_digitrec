...
struct digitrec_knn_vote : public sc_module {
    ...
    sc_signal< sc_lv<6> > tmp_10_cast_fu_133_p1;
    sc_signal< sc_lv<6> > tmp_10_cast_reg_207;
    sc_signal< sc_lv<1> > exitcond1_fu_113_p2;
    sc_signal< sc_lv<2> > j_V_fu_143_p2;
    sc_signal< sc_lv<2> > j_V_reg_215;
    ...
    sc_signal< sc_lv<7> > sum_fu_193_p2;
    ...
    sc_signal< sc_lv<2> > p_1_reg_90;
    sc_signal< sc_lv<7> > min_1_reg_101;
    sc_signal< sc_lv<64> > tmp_11_cast_fu_158_p1;
    sc_signal< sc_lv<5> > tmp_fu_125_p3;
    sc_signal< sc_lv<6> > tmp_7_cast_fu_149_p1;
    sc_signal< sc_lv<6> > tmp_s_fu_153_p2;
    sc_signal< sc_lv<32> > min_1_cast_fu_163_p1;
    sc_signal< sc_lv<1> > tmp_6_fu_167_p2;
    sc_signal< sc_lv<7> > tmp_8_cast_fu_189_p1;
