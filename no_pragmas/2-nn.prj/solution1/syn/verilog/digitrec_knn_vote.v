...
reg    ap_sig_40;
wire   [5:0] tmp_10_cast_fu_133_p1;
reg   [5:0] tmp_10_cast_reg_207;
wire   [0:0] exitcond1_fu_113_p2;
wire   [1:0] j_V_fu_143_p2;
reg   [1:0] j_V_reg_215;
...
reg   [31:0] min_reg_78;
reg   [1:0] p_1_reg_90;
reg   [6:0] min_1_reg_101;
wire   [63:0] tmp_11_cast_fu_158_p1;
wire   [4:0] tmp_fu_125_p3;
wire   [5:0] tmp_7_cast_fu_149_p1;
wire   [5:0] tmp_s_fu_153_p2;
wire   [31:0] min_1_cast_fu_163_p1;
wire   [0:0] tmp_6_fu_167_p2;
wire   [6:0] tmp_8_cast_fu_189_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond1_fu_113_p2 == 1'b0))) begin
        tmp_10_cast_reg_207[4 : 1] <= tmp_10_cast_fu_133_p1[4 : 1];
    end
end
...
assign exitcond_fu_137_p2 = ((p_1_reg_90 == ap_const_lv2_2) ? 1'b1 : 1'b0);

assign i_V_fu_119_p2 = (i_val_V_reg_66 + ap_const_lv4_1);

assign j_V_fu_143_p2 = (p_1_reg_90 + ap_const_lv2_1);
...
assign tmp_fu_125_p3 = {{i_val_V_reg_66}, {1'b0}};

assign tmp_s_fu_153_p2 = (tmp_10_cast_reg_207 + tmp_7_cast_fu_149_p1);

always @ (posedge ap_clk) begin
    tmp_10_cast_reg_207[0] <= 1'b0;
    tmp_10_cast_reg_207[5] <= 1'b0;
end
