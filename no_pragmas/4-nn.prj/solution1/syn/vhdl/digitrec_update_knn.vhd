...
architecture behav of digitrec_update_knn is 
    ...
    signal tmp_6_cast_fu_150_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_6_cast_reg_260 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal min_distances_V_addr_reg_297 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_5_fu_142_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal train_inst_V_cast_fu_154_p1 : STD_LOGIC_VECTOR (48 downto 0);
    signal tmp_5_i_fu_176_p2 : STD_LOGIC_VECTOR (48 downto 0);
    signal tmp_2_cast_fu_200_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_8_fu_204_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_cast_fu_214_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_7_fu_218_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((ap_const_lv1_0 = exitcond_fu_188_p2)))) then
                min_distances_V_addr_reg_297 <= tmp_7_cast_fu_223_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)))) then
                    tmp_6_cast_reg_260(5 downto 2) <= tmp_6_cast_fu_150_p1(5 downto 2);
            end if;
        end if;
    end process;
    tmp_6_cast_reg_260(1 downto 0) <= "00";
    tmp_6_cast_reg_260(6) <= '0';
    ...
    exitcond_fu_188_p2 <= "1" when (val_assign_reg_130 = ap_const_lv3_4) else "0";
    i_fu_194_p2 <= std_logic_vector(unsigned(val_assign_reg_130) + unsigned(ap_const_lv3_1));
    ...
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st5_fsm_4)) then 
            ...
            min_distances_V_address0 <= tmp_7_cast_fu_223_p1(6 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (ap_const_lv1_0 = exitcond_fu_188_p2))) then 
            min_distances_V_address0 <= tmp_8_cast_fu_209_p1(6 - 1 downto 0);
        else 
    ...
    tmp_2_cast_fu_200_p1 <= std_logic_vector(resize(unsigned(val_assign_reg_130),7));
    tmp_3_fu_228_p2 <= "1" when (unsigned(min_distances_V_q0) > unsigned(p_s_reg_106)) else "0";
    tmp_5_fu_142_p3 <= (tmp_4 & ap_const_lv2_0);
    tmp_5_i_fu_176_p2 <= std_logic_vector(unsigned(n_V_buf_i_reg_97) + unsigned(ap_const_lv49_1FFFFFFFFFFFF));
    tmp_6_cast_fu_150_p1 <= std_logic_vector(resize(unsigned(tmp_5_fu_142_p3),7));
    ...
    tmp_cast_fu_214_p1 <= std_logic_vector(resize(unsigned(p_026_s_reg_118),7));
