...
architecture behav of digitrec_knn_vote is 
    ...
    signal tmp_10_cast_fu_133_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_10_cast_reg_207 : STD_LOGIC_VECTOR (6 downto 0);
    signal exitcond1_fu_113_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_V_fu_143_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal j_V_reg_215 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal sum_fu_193_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond1_fu_113_p2 = ap_const_lv1_0))) then
                    tmp_10_cast_reg_207(5 downto 2) <= tmp_10_cast_fu_133_p1(5 downto 2);
            end if;
        end if;
    end process;
    tmp_10_cast_reg_207(1 downto 0) <= "00";
    tmp_10_cast_reg_207(6) <= '0';
    ...
    exitcond_fu_137_p2 <= "1" when (p_1_reg_90 = ap_const_lv3_4) else "0";
    i_V_fu_119_p2 <= std_logic_vector(unsigned(i_val_V_reg_66) + unsigned(ap_const_lv4_1));
    j_V_fu_143_p2 <= std_logic_vector(unsigned(p_1_reg_90) + unsigned(ap_const_lv3_1));
    knn_set_V_address0 <= tmp_11_cast_fu_158_p1(6 - 1 downto 0);
    ...
    tmp_10_cast_fu_133_p1 <= std_logic_vector(resize(unsigned(tmp_fu_125_p3),7));
    ...
    tmp_7_cast_fu_149_p1 <= std_logic_vector(resize(unsigned(p_1_reg_90),7));
    tmp_8_cast_fu_189_p1 <= std_logic_vector(resize(unsigned(knn_set_V_q0),8));
    tmp_fu_125_p3 <= (i_val_V_reg_66 & ap_const_lv2_0);
