...
reg    ap_sig_22;
wire   [6:0] tmp_6_cast_fu_150_p1;
reg   [6:0] tmp_6_cast_reg_260;
...
reg   [5:0] min_distances_V_addr_reg_297;
...
wire   [5:0] tmp_5_fu_142_p3;
wire   [48:0] train_inst_V_cast_fu_154_p1;
wire   [48:0] tmp_5_i_fu_176_p2;
wire   [6:0] tmp_2_cast_fu_200_p1;
wire   [6:0] tmp_8_fu_204_p2;
wire   [6:0] tmp_cast_fu_214_p1;
wire   [6:0] tmp_7_fu_218_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~(ap_start == 1'b0))) begin
        tmp_6_cast_reg_260[5 : 2] <= tmp_6_cast_fu_150_p1[5 : 2];
    end
end
...
assign exitcond_fu_188_p2 = ((val_assign_reg_130 == ap_const_lv3_4) ? 1'b1 : 1'b0);

assign i_fu_194_p2 = (val_assign_reg_130 + ap_const_lv3_1);
...
assign tmp_5_fu_142_p3 = {{tmp_4}, {ap_const_lv2_0}};
...
always @ (posedge ap_clk) begin
    tmp_6_cast_reg_260[1:0] <= 2'b00;
    tmp_6_cast_reg_260[6] <= 1'b0;
end
