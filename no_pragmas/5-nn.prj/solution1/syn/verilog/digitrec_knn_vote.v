...
reg    ap_sig_40;
wire   [6:0] tmp_1_fu_141_p2;
reg   [6:0] tmp_1_reg_217;
wire   [0:0] exitcond1_fu_113_p2;
wire   [2:0] j_V_fu_153_p2;
reg   [2:0] j_V_reg_225;
reg    ap_sig_cseq_ST_st3_fsm_2;
reg    ap_sig_55;
wire   [0:0] exitcond_fu_147_p2;
wire   [3:0] agg_result_V_0_agg_result_V_s_fu_183_p3;
wire   [31:0] min_2_min_fu_191_p3;
wire   [8:0] sum_fu_203_p2;
...
reg   [31:0] min_reg_78;
reg   [2:0] p_1_reg_90;
reg   [8:0] min_1_reg_101;
wire   [63:0] tmp_12_cast_fu_168_p1;
wire   [5:0] tmp_s_fu_129_p3;
wire   [6:0] tmp_cast_fu_125_p1;
wire   [6:0] p_shl_cast_fu_137_p1;
wire   [6:0] tmp_7_cast_fu_159_p1;
wire   [6:0] tmp_2_fu_163_p2;
wire   [31:0] min_1_cast_fu_173_p1;
wire   [0:0] tmp_6_fu_177_p2;
wire   [8:0] tmp_8_cast_fu_199_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & ~(1'b0 == exitcond_fu_147_p2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st3_fsm_2 : begin
            if (~(1'b0 == exitcond_fu_147_p2)) begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end else begin
...
assign agg_result_V_0_agg_result_V_s_fu_183_p3 = ((tmp_6_fu_177_p2[0:0] === 1'b1) ? i_val_V_reg_66 : agg_result_V_s_reg_54);
...
assign exitcond_fu_147_p2 = ((p_1_reg_90 == ap_const_lv3_5) ? 1'b1 : 1'b0);

assign i_V_fu_119_p2 = (i_val_V_reg_66 + ap_const_lv4_1);

assign j_V_fu_153_p2 = (p_1_reg_90 + ap_const_lv3_1);

assign knn_set_V_address0 = tmp_12_cast_fu_168_p1;

assign min_1_cast_fu_173_p1 = min_1_reg_101;

assign min_2_min_fu_191_p3 = ((tmp_6_fu_177_p2[0:0] === 1'b1) ? min_1_cast_fu_173_p1 : min_reg_78);

assign p_shl_cast_fu_137_p1 = tmp_s_fu_129_p3;

assign sum_fu_203_p2 = (min_1_reg_101 + tmp_8_cast_fu_199_p1);

assign tmp_12_cast_fu_168_p1 = tmp_2_fu_163_p2;

assign tmp_1_fu_141_p2 = (tmp_cast_fu_125_p1 + p_shl_cast_fu_137_p1);

assign tmp_2_fu_163_p2 = (tmp_1_reg_217 + tmp_7_cast_fu_159_p1);

assign tmp_6_fu_177_p2 = (($signed(min_1_cast_fu_173_p1) < $signed(min_reg_78)) ? 1'b1 : 1'b0);

assign tmp_7_cast_fu_159_p1 = p_1_reg_90;

assign tmp_8_cast_fu_199_p1 = knn_set_V_q0;

assign tmp_cast_fu_125_p1 = i_val_V_reg_66;

assign tmp_s_fu_129_p3 = {{i_val_V_reg_66}, {ap_const_lv2_0}};
