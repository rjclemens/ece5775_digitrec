...
set C_modelArgList {
	...
	{ min_distances_V int 6 regular {array 50 { 2 3 } 1 1 }  }
	{ tmp_4 int 4 regular  }
}
...
set portList { 
	...
	{ min_distances_V_address0 sc_out sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "min_distances_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "min_distances_V", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	min_distances_V { ap_memory {  { min_distances_V_address0 mem_address 1 6 }  { min_distances_V_ce0 mem_ce 1 1 }  { min_distances_V_we0 mem_we 1 1 }  { min_distances_V_d0 mem_din 1 6 }  { min_distances_V_q0 mem_dout 0 6 } } }
